                    ...
                    >
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                        <div>
                          ...
                          />
                          {errors.name && (
                            <p className="font-sans text-xs text-red-500 mt-1.5">{errors.name.message}</p>
                          )}
                        </div>
                        ...
                        <div>
                          ...
                          />
                          {errors.company && (
                            <p className="font-sans text-xs text-red-500 mt-1.5">{errors.company.message}</p>
                          )}
                        </div>
                      </div>
                      ...
                      <div>
                        ...
                        />
                        {errors.email && (
                          <p className="font-sans text-xs text-red-500 mt-1.5">{errors.email.message}</p>
                        )}
                      </div>
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                        <div>
                          ...
                          />
                          {errors.industry && (
                            <p className="font-sans text-xs text-red-500 mt-1.5">{errors.industry.message}</p>
                          )}
                        </div>
